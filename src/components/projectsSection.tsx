    ...
    <section className="max-w-7xl mx-auto px-4 py-16 pt-72 mb-60">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project) => (
          <div
            key={project.id}
            className="bg-gradient-to-b from-slate-800 p-5 rounded-lg shadow-lg min-h-[250px] lg:min-h-[300px] flex flex-col justify-between cursor-pointer transform transition duration-300 hover:scale-105 hover:shadow-2xl"
